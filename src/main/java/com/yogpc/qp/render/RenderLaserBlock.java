...
public class RenderLaserBlock implements ISimpleBlockRenderingHandler {
    ...
    @Override
    public boolean renderWorldBlock(final IBlockAccess iblockaccess, final int x, final int y, final int z,
        final Block block, final int l, final RenderBlocks renderblocks) {
    ...
    @Override
    public void renderInventoryBlock(final Block block, final int i, final int j, final RenderBlocks renderblocks) {
