    ...
    public void initGui() {
        ...
        this.buttonList.add(
            new GuiButton(
                ...
                100,
                20,
                StatCollector.translateToLocal("FD.UP")));
        this.buttonList.add(
            new GuiButton(
                ...
                100,
                20,
                StatCollector.translateToLocal("FD.DOWN")));
        this.buttonList.add(
            new GuiButton(
                ...
                100,
                20,
                StatCollector.translateToLocal("FD.SOUTH")));
        this.buttonList.add(
            new GuiButton(
                ...
                100,
                20,
                StatCollector.translateToLocal("FD.NORTH")));
        this.buttonList.add(
            new GuiButton(
                ...
                100,
                20,
                StatCollector.translateToLocal("FD.EAST")));
        this.buttonList.add(
            new GuiButton(
                ...
                100,
                20,
                StatCollector.translateToLocal("FD.WEST")));
    }
