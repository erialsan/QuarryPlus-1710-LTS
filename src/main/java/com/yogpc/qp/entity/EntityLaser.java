...
public class EntityLaser extends Entity {
    ...
    public EntityLaser(final World world, final double i, final double j, final double k, final double iSize,
        final double jSize, final double kSize, final int tex) {
        super(world);
