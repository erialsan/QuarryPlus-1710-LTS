...
public class BlockRefinery extends ADismCBlock {
    ...
    @Override
    public void onBlockPlacedBy(final World w, final int x, final int y, final int z, final EntityLivingBase el,
        final ItemStack is) {
        ...
        final ForgeDirection[] da = { ForgeDirection.NORTH, ForgeDirection.EAST, ForgeDirection.SOUTH,
            ForgeDirection.WEST };
    ...
    private static void consumeItem(final EntityPlayer ep, final ItemStack stack) {
        final ItemStack container = stack.getItem()
    ...
    private static boolean fill(final IFluidHandler tank, final ForgeDirection side, final EntityPlayer player) {
