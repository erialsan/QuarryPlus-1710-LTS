...
public class ReflectionHelper {
    ...
    public static final List<Method> getMethods(final Class<?> t, final Class<? extends Annotation> a) {
        ...
        while (c != null && c != Object.class) {
            for (final Method m : c.getDeclaredMethods()) if (m.isAnnotationPresent(a)) {
    ...
    public static final Method getMethod(final Class<?> t, final String[] sv, final Class<?>[]... av) {
        ...
        Class<?> c = t;
        while (c != null && c != Object.class) {
            for (final String element : sv) for (final Class<?>[] element2 : av) try {
        ...
        for (final Exception e : ec) e.printStackTrace();
        return null;
    }
