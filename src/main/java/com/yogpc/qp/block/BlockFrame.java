...
public class BlockFrame extends Block {
    ...
    public void setSides(final boolean yn, final boolean yp, final boolean zn, final boolean zp, final boolean xn,
        final boolean xp) {
        this.sides[0] = yn;
        this.sides[1] = yp;
        this.sides[2] = zn;
    ...
    @Override
    public MovingObjectPosition collisionRayTrace(final World world, final int i, final int j, final int k,
        final Vec3 vec3d, final Vec3 vec3d1) {
        float xMin = 0.25F, xMax = 0.75F, yMin = 0.25F, yMax = 0.75F, zMin = 0.25F, zMax = 0.75F;
        if (world.getBlock(i - 1, j, k) == this) xMin = 0;
        if (world.getBlock(i + 1, j, k) == this) xMax = 1;
        if (world.getBlock(i, j - 1, k) == this) yMin = 0;
