...
public class GuiP_List extends GuiScreenA implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.buttonList.add(
            this.delete = new GuiButton(
                PacketHandler.CtS_REMOVE_MAPPING,
                this.width * 2 / 3 + 10,
                70,
                100,
                20,
        ...
        this.buttonList.add(
            this.top = new GuiButton(
                PacketHandler.CtS_TOP_MAPPING,
                this.width * 2 / 3 + 10,
                95,
                100,
                20,
        ...
        this.buttonList.add(
            this.up = new GuiButton(
                PacketHandler.CtS_UP_MAPPING,
                this.width * 2 / 3 + 10,
                120,
                100,
                20,
        ...
        this.buttonList.add(
            this.down = new GuiButton(
                PacketHandler.CtS_DOWN_MAPPING,
                this.width * 2 / 3 + 10,
                145,
                100,
                20,
        ...
        this.buttonList.add(
            this.bottom = new GuiButton(
                PacketHandler.CtS_BOTTOM_MAPPING,
                this.width * 2 / 3 + 10,
                170,
                100,
                20,
                StatCollector.translateToLocal("tof.bottom")));
        this.oreslot = new GuiP_SlotList(
            this.mc,
            this.width * 3 / 5,
            this.height,
            30,
    ...
    public void actionPerformed(final GuiButton par1) {
        switch (par1.id) {
            ...
            case PacketHandler.CtS_REMOVE_MAPPING:
                ...
                if (FluidRegistry.isFluidRegistered(name)) name = FluidRegistry.getFluid(name)
                    .getLocalizedName(FluidRegistry.getFluidStack(name, 0));
                this.mc.displayGuiScreen(
                    new GuiYesNo(this, StatCollector.translateToLocal("tof.deletefluidsure"), name, par1.id));
                break;
            default:
    ...
    public void drawScreen(final int i, final int j, final float k) {
        ...
        drawCenteredString(
            ...
            StatCollector.translateToLocal("pp.list.setting") + StatCollector.translateToLocal(
                "FD." + ForgeDirection.getOrientation(this.dir)
                    .toString()),
            this.width / 2,
            8,
            0xFFFFFF);
    ...
    public void confirmClicked(final boolean par1, final int par2) {
        if (par1) PacketHandler
            .sendPacketToServer(this.tile, (byte) par2, this.dir, this.oreslot.target.get(this.oreslot.currentore));
