...
public class GuiP_SlotList extends GuiSlot {
    ...
    public GuiP_SlotList(final Minecraft par1Minecraft, final int par2, final int par3, final int par4, final int par5,
        final GuiScreen parents, final List<String> ali) {
