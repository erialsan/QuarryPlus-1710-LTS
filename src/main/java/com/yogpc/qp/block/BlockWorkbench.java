...
public class BlockWorkbench extends ADismCBlock {
    ...
    @Override
    public void breakBlock(final World w, final int x, final int y, final int z, final Block b, final int m) {
            ...
            for (int i = 0; i < 27; i++) {
                ...
                if (is != null) {
                    ...
                    while (is.stackSize > 0) {
                        ...
                        if (k1 > is.stackSize) k1 = is.stackSize;
                        is.stackSize -= k1;
                        ...
                        if (is.hasTagCompound()) e.getEntityItem()
                            .setTagCompound(
    ...
    public boolean onBlockActivated(final World w, final int x, final int y, final int z, final EntityPlayer e,
        ...
        if (!w.isRemote) e.openGui(QuarryPlus.I, QuarryPlusI.guiIdWorkbench, w, x, y, z);
        return true;
    }
}
