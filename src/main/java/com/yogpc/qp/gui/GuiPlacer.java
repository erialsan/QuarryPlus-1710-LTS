...
public class GuiPlacer extends GuiContainer {
    ...
    public GuiPlacer(final InventoryPlayer par1InventoryPlayer, final TilePlacer par2TileEntityDispenser) {
    ...
    protected void drawGuiContainerForegroundLayer(final int par1, final int par2) {
        final String s = this.tile.hasCustomInventoryName() ? this.tile.getInventoryName()
