...
public class BlockLaser extends ADismCBlock {
    ...
    public IIcon getIcon(final int i, final int j) {
        if (i == ForgeDirection.values()[j].getOpposite()
            .ordinal()) return this.textureBottom;
        else if (i == j) return this.textureTop;
        else return this.blockIcon;
    }

    @Override
    public int onBlockPlaced(final World world, final int x, final int y, final int z, final int side, final float par6,
