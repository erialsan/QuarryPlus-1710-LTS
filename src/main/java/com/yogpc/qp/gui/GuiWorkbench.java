...
public class GuiWorkbench extends GuiContainer {
    ...
    private static final class MyRenderItem extends RenderItem {
        ...
        @Override
        public void renderItemOverlayIntoGUI(final FontRenderer a, final TextureManager b, final ItemStack c,
            final int d, final int e, final String f) {
    ...
    protected void drawGuiContainerForegroundLayer(final int p_146979_1_, final int p_146979_2_) {
        this.fontRendererObj.drawString(
            this.tile.hasCustomInventoryName() ? this.tile.getInventoryName()
                : StatCollector.translateToLocal(this.tile.getInventoryName()),
            8,
            6,
            0x404040);
        this.fontRendererObj
            .drawString(StatCollector.translateToLocal("container.inventory"), 8, this.ySize - 96 + 2, 0x404040);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(final float p_146976_1_, final int p_146976_2_,
        ...
        if (this.tile.cur_recipe >= 0) {
            ...
            drawTexturedModalRect(
                xf + 8 + this.tile.cur_recipe % 9 * 18,
                yf + 90 + (this.tile.cur_recipe / 9 - 3) * 18,
                this.xSize,
                0,
                16,
                16);
    ...
    private static final Field item = ReflectionHelper
        .getField(ReflectionHelper.getClass("codechicken.nei.guihook.GuiContainerManager"), "drawItems");
