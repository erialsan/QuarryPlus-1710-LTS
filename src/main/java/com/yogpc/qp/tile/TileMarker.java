...
public class TileMarker extends APacketTile implements IAreaProvider {
    ...
    public static void recievePacket(final byte[] pdata) {
        ...
        if (flag == PacketHandler.remove_link) {
            final int index = TileMarker.linkList.indexOf(
                new TileMarker.Link(
                    w,
                    data.readInt(),
                    data.readInt(),
                    ...
                    data.readInt(),
                    data.readInt()));
            if (index >= 0) TileMarker.linkList.get(index)
            ...
            if (index >= 0) TileMarker.laserList.get(index)
                .destructor();
        }
    }
    ...
    public static class Laser {
        ...
        Laser(final World pw, final int px, final int py, final int pz, final Link l) {
            ...
            this.z = pz;
            this.w = pw;
            if (l == null || l.xn == l.xx) this.lasers[0] = new EntityLaser(
                pw,
                px - MAX_SIZE + a,
                py + b,
                pz + b,
            ...
            if (l == null || l.zn == l.zx) this.lasers[2] = new EntityLaser(
                pw,
                px + b,
                py + b,
                pz - MAX_SIZE + a,
                ...
                MAX_SIZE * 2,
                EntityLaser.BLUE_LASER);
            for (final EntityLaser eb : this.lasers) if (eb != null) eb.worldObj.spawnEntityInWorld(eb);
            final int i = TileMarker.laserList.indexOf(this);
            if (i >= 0) TileMarker.laserList.get(i)
                .destructor();
        ...
        public void destructor() {
            ...
            if (!this.w.isRemote) try {
                ...
                dos.writeInt(this.y);
                dos.writeInt(this.z);
                PacketHandler.sendPacketToDimension(
                    new YogpstopPacket(bos.toByteArray(), TileMarker.class),
                    this.w.provider.dimensionId);
            } catch (final IOException e) {
                throw new RuntimeException(e);
            }
            for (final EntityLaser eb : this.lasers) if (eb != null) QuarryPlus.proxy.removeEntity(eb);
        }
    ...
    public static class Link {
        ...
        void init() {
            ...
            if (i >= 0) TileMarker.linkList.get(i)
                .removeConnection(false);
        ...
        void makeLaser() {
            ...
            if ((flag & 1) == 1) this.lasers[0] = new EntityLaser(
                this.w,
                this.xn + a,
                this.yn + b,
                this.zn + b,
            ...
            if ((flag & 2) == 2) this.lasers[4] = new EntityLaser(
                this.w,
                this.xn + b,
                this.yn + a,
                this.zn + b,
                ...
                c,
                EntityLaser.RED_LASER);
            if ((flag & 4) == 4) this.lasers[8] = new EntityLaser(
                this.w,
                this.xn + b,
                this.yn + b,
                this.zn + a,
            ...
            if ((flag & 6) == 6) {
                this.lasers[5] = new EntityLaser(
                    ...
                    c,
                    EntityLaser.RED_LASER);
                this.lasers[10] = new EntityLaser(
                    this.w,
                    this.xn + b,
                    this.yx + b,
                    this.zn + a,
            ...
            if ((flag & 7) == 7) {
                ...
                this.lasers[7] = new EntityLaser(
                    ...
                    c,
                    EntityLaser.RED_LASER);
                this.lasers[11] = new EntityLaser(
                    this.w,
                    this.xx + b,
                    this.yx + b,
                    this.zn + a,
    ...
    public void removeFromWorld() {
        if (this.link == null) {
            QuarryPlusI.blockMarker.dropBlockAsItem(
                this.worldObj,
                this.xCoord,
                this.yCoord,
                this.zCoord,
    ...
    public Collection<ItemStack> removeFromWorldWithItem() {
        ...
        ret.addAll(QuarryPlusI.blockMarker.getDrops(this.worldObj, this.xCoord, this.yCoord, this.zCoord, 0, 0));
        this.worldObj.setBlockToAir(this.xCoord, this.yCoord, this.zCoord);
        return ret;
    }
    ...
    public void G_updateSignal() {
        ...
        if ((this.worldObj.isBlockIndirectlyGettingPowered(this.xCoord, this.yCoord, this.zCoord)
            ...
            && (this.link == null || this.link.xn == this.link.xx
                || this.link.yn == this.link.yx
                || this.link.zn == this.link.zx))
    ...
    public void S_tryConnection() {// onBlockActivated
        ...
        this.link.makeLaser();
        {
            try {
                ...
                PacketHandler.sendPacketToAround(
                    new YogpstopPacket(bos.toByteArray(), this, PacketHandler.StC_LINK_RES),
        ...
        switch (id) {
            case PacketHandler.CtS_LINK_REQ:
                if (this.link != null) try {
                    ...
                    dos.writeInt(this.link.zx);
                    dos.writeInt(this.link.zn);
                    PacketHandler.sendPacketToPlayer(
                        new YogpstopPacket(bos.toByteArray(), this, PacketHandler.StC_LINK_RES),
                        ep);
                } catch (final IOException e) {
                    throw new RuntimeException(e);
    ...
    public void invalidate() {
        super.invalidate();
        if (this.worldObj.getBlock(this.xCoord, this.yCoord, this.zCoord) != QuarryPlusI.blockMarker) G_destroy();
    }
}
