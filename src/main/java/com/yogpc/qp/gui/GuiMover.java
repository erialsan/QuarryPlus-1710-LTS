...
public class GuiMover extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(final int par1, final int par2) {
        this.fontRendererObj.drawString(StatCollector.translateToLocal("tile.EnchantMover.name"), 8, 6, 0x404040);
    ...
    protected void drawGuiContainerBackgroundLayer(final float f, final int i, final int j) {
        ...
        drawTexturedModalRect(
            this.width - this.xSize >> 1,
            this.height - this.ySize >> 1,
            0,
            0,
            this.xSize,
            this.ySize);
    ...
    protected void actionPerformed(final GuiButton par1GuiButton) {
        ...
        PacketHandler
            .sendPacketToServer(new YogpstopPacket(this.inventorySlots, new byte[] { (byte) par1GuiButton.id }));
    }
    ...
    public void updateScreen() {
        ...
        ((GuiButton) this.buttonList.get(1)).displayString = eid >= 0
            ? StatCollector.translateToLocal(Enchantment.enchantmentsList[eid].getName())
            : "";
    }
}
