...
public class QuarryPlusI {
    ...
    public static Block blockQuarry, blockMarker, blockMover, blockMiningWell, blockPump, blockRefinery, blockPlacer,
        blockBreaker, blockLaser, blockPlainPipe, blockFrame, workbench, controller;
    ...
    public void onWorldUnload(final WorldEvent.Unload event) {
        ...
        for (final TileMarker.Link l : la) if (l.w == event.world) l.removeConnection(false);
        final TileMarker.Laser[] lb = TileMarker.laserList.toArray(new TileMarker.Laser[TileMarker.laserList.size()]);
        for (final TileMarker.Laser l : lb) if (l.w == event.world) l.destructor();
    }
    ...
    public static void preInit(final FMLPreInitializationEvent event) {
        ...
        try {
            cfg.load();
            disableController = cfg.get(Configuration.CATEGORY_GENERAL, "DisableSpawnerController", false)
                .getBoolean(false);
            spawnerBlacklist = Arrays.asList(
                cfg.get(Configuration.CATEGORY_GENERAL, "SpawnerControllerEntityBlackList", new String[0])
                    .getStringList());
        ...
        if (!disableController) controller = new BlockController();
    ...
    public static void init() {
        PacketHandler.channels = NetworkRegistry.INSTANCE
            .newChannel("QuarryPlus", new YogpstopPacketCodec(), new PacketHandler());
        final WeightedRandomChestContent c = new WeightedRandomChestContent(new ItemStack(magicmirror), 1, 1, 9);
        ...
        if (!disableController) GameRegistry.registerBlock(controller, "yogSC");
        ...
        GameRegistry.addRecipe(
            ...
            new Object[] { "III", "GDG", "RRR", Character.valueOf('D'), Blocks.diamond_block, Character.valueOf('R'),
                Items.redstone, Character.valueOf('I'), Blocks.iron_block, Character.valueOf('G'), Blocks.gold_block });
        WorkbenchRecipe.addRecipe(
            new ItemStack(magicmirror, 1, 1),
            32000,
            new ItemStack(Items.ender_eye, 400),
            new ItemStack(magicmirror, 50));
        WorkbenchRecipe.addRecipe(
            new ItemStack(magicmirror, 1, 2),
            32000,
            new ItemStack(Items.ender_eye, 400),
            new ItemStack(magicmirror, 50),
            new ItemStack(Blocks.obsidian, 100),
            new ItemStack(Blocks.dirt, 200),
            new ItemStack(Blocks.planks, 200));
        WorkbenchRecipe.addRecipe(
            new ItemStack(armor),
            128000,
            new ItemStack(Items.iron_ingot, 1600),
            new ItemStack(Items.coal, 3200),
            new ItemStack(Items.gold_ingot, 400),
            new ItemStack(Items.diamond, 360),
            new ItemStack(Items.nether_star, 1),
            new ItemStack(Items.ender_eye, 25),
            new ItemStack(Items.glowstone_dust, 100),
            new ItemStack(Items.dye, 100, 10));
        if (!disableController) WorkbenchRecipe.addRecipe(
            new ItemStack(controller),
            1000000,
            new ItemStack(Items.nether_star, 50),
            new ItemStack(Items.rotten_flesh, 1000),
            new ItemStack(Items.arrow, 1000),
            new ItemStack(Items.bone, 1000),
            new ItemStack(Items.gunpowder, 1000),
            new ItemStack(Items.iron_ingot, 2000),
            new ItemStack(Items.gold_ingot, 1000),
            new ItemStack(Items.ghast_tear, 250),
            new ItemStack(Items.magma_cream, 500),
            new ItemStack(Items.blaze_rod, 700),
            new ItemStack(Items.carrot, 50),
            new ItemStack(Items.potato, 50));
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockMarker),
            20000,
            new ItemStack(Items.redstone, 300),
            new ItemStack(Items.dye, 300, 4),
            new ItemStack(Items.gold_ingot, 175),
            new ItemStack(Items.iron_ingot, 150),
            new ItemStack(Items.glowstone_dust, 50),
            new ItemStack(Items.ender_pearl, 10));
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockQuarry),
            320000,
            new ItemStack(Items.diamond, 800),
            new ItemStack(Items.gold_ingot, 800),
            new ItemStack(Items.iron_ingot, 1600),
            new ItemStack(Items.redstone, 400),
            new ItemStack(Items.ender_pearl, 50),
            new ItemStack(Items.nether_star, 3));
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockMover),
            320000,
            new ItemStack(Blocks.obsidian, 1600),
            new ItemStack(Items.diamond, 800),
            new ItemStack(Blocks.anvil, 50),
            new ItemStack(Items.redstone, 1200),
            new ItemStack(Items.gold_ingot, 200),
            new ItemStack(Items.iron_ingot, 200),
            new ItemStack(Items.nether_star, 1),
            new ItemStack(Items.ender_pearl, 25));
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockMiningWell),
            160000,
            new ItemStack(Items.iron_ingot, 800),
            new ItemStack(Items.redstone, 400),
        ...
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockPump),
            320000,
            new ItemStack(Items.iron_ingot, 1200),
            new ItemStack(Items.redstone, 1600),
            new ItemStack(Blocks.glass, 12800),
            new ItemStack(Blocks.cactus, 2000),
            new ItemStack(Items.gold_ingot, 400),
            new ItemStack(Items.nether_star, 1),
            new ItemStack(Items.ender_pearl, 10));
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockRefinery),
            640000,
            new ItemStack(Items.diamond, 900),
            new ItemStack(Items.gold_ingot, 600),
            new ItemStack(Items.iron_ingot, 600),
            new ItemStack(Blocks.glass, 3200),
            new ItemStack(Items.redstone, 800),
            new ItemStack(Blocks.anvil, 50),
            new ItemStack(Blocks.obsidian, 600),
            new ItemStack(Items.nether_star, 1),
            new ItemStack(Items.ender_pearl, 20));
        WorkbenchRecipe.addRecipe(
            ...
            new ItemStack(Items.diamond, 100),
            new ItemStack(Items.redstone, 400),
            new ItemStack(Items.dye, 100, 4),
            new ItemStack(Items.ender_pearl, 3));
        WorkbenchRecipe.addRecipe(
            new ItemStack(itemTool, 1, 1),
            160000,
            new ItemStack(Items.iron_ingot, 400),
            new ItemStack(Items.book, 1600),
            new ItemStack(Items.feather, 50),
            new ItemStack(Items.dye, 400),
            new ItemStack(Items.diamond, 100),
            new ItemStack(Items.redstone, 100),
            new ItemStack(Items.ender_pearl, 3));
        WorkbenchRecipe.addRecipe(
            new ItemStack(itemTool, 1, 2),
            320000,
            new ItemStack(Items.iron_ingot, 1600),
            new ItemStack(Items.lava_bucket, 60),
            new ItemStack(Items.water_bucket, 60),
            new ItemStack(Items.ender_pearl, 3));
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockBreaker),
            320000,
            new ItemStack(Items.redstone, 1600),
            ...
            new ItemStack(Items.ender_pearl, 50));
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockPlacer),
            320000,
            new ItemStack(Items.redstone, 1600),
            new ItemStack(Items.diamond, 600),
            new ItemStack(Items.gold_ingot, 1600),
            new ItemStack(Items.iron_ingot, 800),
            new ItemStack(Items.ender_pearl, 50));
        WorkbenchRecipe.addRecipe(
            new ItemStack(blockLaser),
            640000,
            new ItemStack(Items.diamond, 400),
            new ItemStack(Items.redstone, 4800),
            new ItemStack(Blocks.obsidian, 800),
            new ItemStack(Blocks.glass, 3600),
            new ItemStack(Items.glowstone_dust, 1600),
            new ItemStack(Items.gold_ingot, 800),
    ...
    public static class BlockData {
        ...
        public boolean equals(final Object o) {
            if (o instanceof BlockData) return this.name.equals(((BlockData) o).name)
                && (this.meta == ((BlockData) o).meta || this.meta == OreDictionary.WILDCARD_VALUE
                    || ((BlockData) o).meta == OreDictionary.WILDCARD_VALUE);
            return false;
        }
