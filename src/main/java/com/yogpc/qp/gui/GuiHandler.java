...
public class GuiHandler implements IGuiHandler {
    ...
    @Override
    public Object getClientGuiElement(final int ID, final EntityPlayer p, final World w, final int x, final int y,
        final int z) {
        switch (ID) {
            ...
            case QuarryPlusI.guiIdPump + 5:
                return new GuiP_List((byte) (ID - QuarryPlusI.guiIdPump), (TilePump) w.getTileEntity(x, y, z));
    ...
    @Override
    public Object getServerGuiElement(final int ID, final EntityPlayer p, final World w, final int x, final int y,
        final int z) {
        switch (ID) {
            case QuarryPlusI.guiIdMover:
