...
public class TileMiningWell extends TileBasic {
    ...
    private boolean S_checkTarget(final int depth) {
        ...
        final Block b = this.worldObj.getChunkProvider()
            .loadChunk(this.xCoord >> 4, this.zCoord >> 4)
        ...
        if (b == null || h < 0
            || b == QuarryPlusI.blockPlainPipe
            || b.isAir(this.worldObj, this.xCoord, depth, this.zCoord)) return false;
        if (this.pump == ForgeDirection.UNKNOWN && b.getMaterial()
