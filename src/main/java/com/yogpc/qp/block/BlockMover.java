...
public class BlockMover extends Block implements IDismantleable {
    ...
    @Override
    public boolean onBlockActivated(final World w, final int x, final int y, final int z, final EntityPlayer e,
        final int par6, final float par7, final float par8, final float par9) {
        if (!w.isRemote) e.openGui(QuarryPlus.I, QuarryPlusI.guiIdMover, w, x, y, z);
        return true;
    }
